    ...
    <div className="app">
      <div className="sidebar">
        ...
        <Button onClick={handleShowAddFriends}>
          {showAddFriendForm ? "Close form" : "Add friend"}
        </Button>
      </div>
...
function FormAddFriend({ onAddFriend }) {
  ...
  const [image, setImageUrl] = useState("https://i.pravatar.cc/48?u=499476");
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  function handleSubmit(e) {
    ...
    if (!bill || !paidByUser) {
      alert("Please provide a bill value and your expense");
      return;
    }
